-- Add set_code filter to get_random_cards for expansion-scoped Ink VS / Clash.
...
BEGIN
  ...
  RETURN QUERY
    SELECT DISTINCT ON (o.oracle_id)
      o.oracle_id, o.name, o.slug, o.layout, o.type_line, o.mana_cost, o.colors, o.cmc
    FROM oracle_cards o
    LEFT JOIN printings p ON p.oracle_id = o.oracle_id
    WHERE

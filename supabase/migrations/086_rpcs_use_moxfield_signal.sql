-- Phase 4 (minimal): wire commander_chosen_30d from popularity_signals
-- into the popularity sort on get_top_illustrations and
-- get_illustrations_for_set. This replaces "ELO from internal votes"
-- (sparse, default 1500) with real Moxfield deck-curation data as the
-- primary popularity signal, falling back to ELO then card_name for
-- illustrations not yet in any commander deck.

...
export const metadata = {
  title: "Play - MTG Ink",
  description: "Compare and rank Magic: The Gathering art. Vote in daily challenges, brackets, and head-to-head matchups.",
  alternates: { canonical: "https://mtg.ink/play" },
};

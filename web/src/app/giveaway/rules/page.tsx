      ...
      <section className="space-y-4 text-sm leading-relaxed">
        ...
        <div>
          ...
          <p>
            ...
            entry process or violates these Official Rules. No botting, automated account
            creation, or automated entries are permitted. Any entries generated by script,
            macro, bot, or other automated means will be void and may result in
            disqualification. By entering, participants agree to be bound by these Official
            Rules and the decisions of the Sponsor, which are final and binding in all
            respects.
          </p>
        </div>
